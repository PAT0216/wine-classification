...
corss_valid_df = pd.read_csv("../results/models/cross_val_results.csv")
...
![Confusion Matrix](../results/models/confusion_matrix.png){#fig-confusion-matrix width=50%}
...
test_metrics_df = pd.read_csv("../results/models/test_metrics.csv")
